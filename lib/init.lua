...
Iris.TemplateConfig = if getgenv then loadstring(game:HttpGet("https://raw.githubusercontent.com/Sigmanic/Iris/main/lib/config.lua"))() else require(script.config)
